...
1. A non-blocking scripted movement state machine.
2. A Wi-Fi TCP version that sends live telemetry and accepts movement commands from a Python program.
...
| Field | Description |
|---|---|
| `time_ms` | ESP32 runtime in milliseconds |
| `temp_c` | Temperature in degrees Celsius |
| `humidity_percent` | Relative humidity |
| `light_raw` | Raw photoresistor reading |
| `light_status` | Dark, Dim, Light, Bright, or Very_bright |
| `accel_x/y/z` | Acceleration from the MPU6050 |
| `gyro_x/y/z` | Angular velocity from the MPU6050 |
| `rover_state` | Current rover movement state |
| `system_status` | Overall sensor or warning status |
